...
function _precompile_()
    ...
    @enforce precompile(Tuple{typeof(CrystalNets.small_cycles_around), graph, p_pos, mat, Int, PeriodicVertex3D, Vector{Int}, Set{Int}})
    @enforce precompile(Tuple{typeof(CrystalNets.in_small_cycles_around), graph, p_pos, mat, Int, Vector{Int}, Set{Int}})
    ...
    @enforce precompile(Tuple{typeof(CrystalNets.fix_valence!), PeriodicGraph3D, p_pos, types, Vector{Int}, Vector{Int}, fmat, Val{true}, opts})
    @enforce precompile(Tuple{typeof(CrystalNets.fix_valence!), PeriodicGraph3D, p_pos, types, Vector{Int}, Vector{Int}, fmat, Val{false}, opts})
