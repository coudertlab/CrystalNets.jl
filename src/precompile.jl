...
function _precompile_()
    ...
    # CrystalNets
    Base.precompile(Tuple{Core.kwftype(typeof(CrystalNets.reckognize_topologies)),NamedTuple{(:ignore_atoms,), Tuple{Tuple{Symbol}}},typeof(CrystalNets.reckognize_topologies),String})
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(CrystalNets.parse_chemfile)),NamedTuple{(:ignore_atoms,), Tuple{Tuple{Symbol}}},typeof(CrystalNets.reckognize_topologies),String})
    Base.precompile(Tuple{Core.kwftype(typeof(CrystalNets.parse_chemfile)),NamedTuple{(:ignore_atoms,), Tuple{Tuple{Symbol}}},typeof(CrystalNets.reckognize_topologies),String,Bool})
    ...
    Base.precompile(Tuple{typeof(reckognize_topology),PeriodicGraph3D})
